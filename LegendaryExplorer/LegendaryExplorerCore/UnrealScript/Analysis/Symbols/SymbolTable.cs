    ...
    internal class SymbolTable
    {
        ...
        public bool AddType(VariableType node)
        {
            ...
            switch (node.Name)
            {
                ...
                case "Material":
                {
                    ((Class)node).VariableDeclarations.Add(new VariableDeclaration(new DynamicArrayType(TypeDict["Guid"]), EPropertyFlags.Transient | EPropertyFlags.BioNonShip | EPropertyFlags.EditorOnly, "ReferencedTextureGuids")
                    {
                        Outer = node
                    });
                    ((Class)node).VariableDeclarations.Add(new VariableDeclaration(new DynamicArrayType(TypeDict["Object"]), EPropertyFlags.Transient | EPropertyFlags.BioNonShip | EPropertyFlags.EditorOnly, "EditorComments")
                    {
                        Outer = node
                    });
                    break;
